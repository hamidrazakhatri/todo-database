...
const firebaseConfig = {
    apiKey: "AIzaSyCjwyWChmIQbp5fo4QBf7KzQjjxsQRboLk",
    authDomain: "todo-data-d44f9.firebaseapp.com",
    projectId: "todo-data-d44f9",
    storageBucket: "todo-data-d44f9.appspot.com",
    messagingSenderId: "165155958277",
    appId: "1:165155958277:web:6c3aa20239e395b562b66c",
    measurementId: "G-XH2YVVP9ZH"
  };
    ...
    onValue(userref, function (data) {
        ...
        if (data.val()) {
            ...
            for (var i = 0; i < reseavedata.length; i++) {
                ...
                // console.log(kuchaur)
                ul.innerHTML += `<li>${reseavedata[i].todo}<div class="listbtn"><button onclick="del('${kuchaur}')">delete</button><button onclick="edit('${kuchaur}')">edit</button></div></li>`
            }
        }
    })
}
